...
venom.sendMessage(from,{audio: { url: "./midia/rindo.mp3" }, mimetype: 'audio/mp4' },{quoted:m})
 break
                ...
                case 'bebito':
        case 'fiufiu':
venom.sendMessage(from,{audio: { url: "./midia/bebito.mp3" }, mimetype: 'audio/mp4' },{quoted:m})
 break
 case 'musipaysup':
venom.sendMessage(from,{audio: { url: "./musica/paysup.mp3" }, mimetype: 'audio/mp4' },{quoted:m})
break
                 case 'amar':
                case 'amaresprimavera':
        case 'kirazmevsemi':
venom.sendMessage(from,{audio: { url: "./midia/amar.mp3" }, mimetype: 'audio/mp4' },{quoted:m})
 break

	    case 'comprabot': {	    
                enviar(`Para comprar el bot , comuniquese con mi creador:\n\nhttps://wa.me/13477777655?text=quiero+comprar+a+minibot`)
            }
...
break
          ...
          case 'creador': case 'autor':  case 'owner': case 'creator': case 'criador': case 'dono': {
                ...
                let vcard = 'BEGIN:VCARD\n' // metadata do ctt
                    ...
                    + 'FN:Laura Garcia.\n' // nome todo
                    + 'ORG:Laura Garcia;\n' // organização
                    + 'TEL;type=CELL;type=VOICE;waid=9563294668:+19563294668\n' // WhatsApp ID + número
                    + 'END:VCARD' // finalização
                venom.sendMessage(m.chat, { contacts: { displayName: 'Laura Garcia', contacts: [{ vcard }] } }, { quoted: m })
            }
    ...
    case 'hola': case 'paysup': {
            
venomkkk = `Hola *${pushname}* mi nombre es *Laura Garcia* un placer saludarte, te escribo de Estados unidos`
                        ...
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                ...
                                urlButton: {
                                    ...
                                    url: 'https://sys.paysupgo.com/landing'
                                }  
                                },{
...
//  footerText: 'Paysup',
//  description: `✨ Estas tomando la mejor decisión de tu vida *${pushname}*✨ te mostrare los medios de pago`,
//  sections: [
//                      {
